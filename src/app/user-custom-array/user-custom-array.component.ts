...
@Component({
  selector: 'app-user-custom-array',
  templateUrl: './user-custom-array.component.html',
  styleUrls: ['./user-custom-array.component.css']
})
export class UserCustomArrayComponent implements OnInit {
